...
async function studentDashboard(){
 ...
 top('PakKom Exambro','<div class="wrap"><div class="card"><div class="row"><div><span class="pill">Kelas '+esc(state.classId)+'</span><h1 style="margin-top:10px">'+esc(state.student.name)+'</h1><p class="muted">NIS: '+esc(state.student.nis)+'</p></div><div class="pill green">Sesi Aktif</div></div></div><div class="card"><div class="section-head"><div><h2>Jadwal Ujian</h2><p class="muted">Ujian dikelompokkan berdasarkan hari, tanggal, dan waktu.</p></div></div>'+cards+'</div></div>',studentLogout,'Keluar');
