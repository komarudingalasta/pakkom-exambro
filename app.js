...
async function admin(){
 ...
 el('mResult').onclick=examResultsAdmin;el('mBrand').onclick=brandingAdmin;el('seeAllExam').onclick=examsAdmin;
...
function openAdminQuickMenu(){
 ...
 var go={class:classesAdmin,student:studentsAdmin,exam:examsAdmin,monitor:examControlCenter,result:examResultsAdmin,brand:brandingAdmin,logout:adminLogout};
...
async function examsAdmin(){
 ...
 var body='<main class="wrap exam-admin-v166"><div class="page-title-row"><div><h1>Kelola Ujian</h1><p class="muted">Daftar jadwal ujian.</p></div><button class="btn outline add-exam-button" id="toggleExamForm">＋ Tambah Ujian</button></div>'+addForm+'<section class="exam-schedule-list">'+cards+'</section></main>';
